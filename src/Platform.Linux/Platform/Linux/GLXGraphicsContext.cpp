...
namespace Platform
{
    namespace Linux
    {
        ...
        GLXGraphicsContext* GLXGraphicsContext::Create(unsigned int majorVersion,
                                                       ...
                                                       GLXFBConfig fbConfig)
        {
            ...
            {
                return CreateOldContext(pDisplay, window, fbConfig);
            }
            else if(majorVersion == 3)
            {
                return CreateNewContext(pDisplay, window, fbConfig);
            }

            throw std::runtime_error("Unsupported OpenGL Context requested");
        }

        GLXGraphicsContext* GLXGraphicsContext::CreateOldContext(Display* pDisplay, Window window, GLXFBConfig fbConfig)
        {
            ...
            {
                throw std::runtime_error("GLX_ARB_create_context not supported");
            }
        ...
        GLXGraphicsContext* GLXGraphicsContext::CreateNewContext(Display* pDisplay, Window window, GLXFBConfig fbConfig)
        {
            // Get the default screen's GLX extension list
            const char* glxExts = glXQueryExtensionsString(pDisplay, DefaultScreen(pDisplay));
